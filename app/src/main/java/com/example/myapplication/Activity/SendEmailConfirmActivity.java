...
public class SendEmailConfirmActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_send_email_confirm);
        ...
        if(!email.isEmpty()) {
            new Thread(() -> {
                try {
                    sendMail(email);
                    runOnUiThread(() -> {
                        Intent intent = new Intent(SendEmailConfirmActivity.this, VerifyCodeActivity.class);
